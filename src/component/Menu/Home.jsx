          ...
          <div className="row align-items-center justify-content-between">
            <div className="col-md-6">
              <div className="download-content">
                ...
                <a className="btn theme-btn btn-style-one mt-md-4 mt-2" href="_">Click Here to Find Out!</a>
          ...
          <div className="row align-items-center">
            <div className="col-md-6 text-right">
              <figure className="text-center">
                <img src="./images/demo-qr.png" alt="Demo QR" />
                <figcaption className="mt-2n pt-0 ">Demo QR</figcaption>
              </figure>
            </div>

            <div className="col-lg-6">
              <h2 className="text-left text-md-left">The QR-Code</h2>
              <p className="lead mb-2 mb-md-4 ">You can create one or more QR codes for each Business. It contains the
