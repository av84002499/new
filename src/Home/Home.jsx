          ...
          <div id="carouselExampleFade" className="carousel slide carousel-fade" data-bs-ride="carousel">
            <div className="carousel-inner">
              <div className="carousel-item active">
                ...
                <div className="carousel-caption d-flex flex-column flex-lg-row align-items-center text-center text-lg-start">
                  <div className="b-flip-text mb-3 mb-lg-0">
            ...
            <div className="row align-items-center justify-content-between">
              <div className="col-md-6">
                <div className="download-content">
                  <h3 className="">Enhancing Customer Interaction: Digital Menu Solutions for Businesses</h3>
